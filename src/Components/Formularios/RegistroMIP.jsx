...
function RegistroMIP({ moduloActivo, formularioSeleccionado }) {
  ...
  const tituloFormulario = `${gerencia} / MIP L1`;
  ...
  const enviarFormulario = (event) => {
    ...
    console.log("Formulario Registro MIP demo:", datosDemo);
